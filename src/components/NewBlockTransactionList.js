  ...
  renderExternalTransactions() {
    ...
    return (
      <div>
        ...
        <p>
          As a miner you can add as many transactions as possible to collect the fees. Remember, you will still have to find a valid nonce that makes your block hash valid and then broadcast it!
        </p>
        <TransactionTable
